...
public:
    ...
    intrusive_ptr( T * p, bool add_ref = true ) BOOST_SP_NOEXCEPT : px( p )
    {
    ...
    intrusive_ptr( intrusive_ptr<U> const & rhs ) BOOST_SP_NOEXCEPT
    ...
    intrusive_ptr(intrusive_ptr const & rhs) BOOST_SP_NOEXCEPT : px( rhs.px )
    {
        if( px != 0 ) intrusive_ptr_add_ref( px );
    }

    ~intrusive_ptr() BOOST_SP_NOEXCEPT
    {
...
// Move support
    ...
    intrusive_ptr(intrusive_ptr<U> && rhs) BOOST_SP_NOEXCEPT
    ...
    intrusive_ptr & operator=(intrusive_ptr const & rhs) BOOST_SP_NOEXCEPT
    {
        this_type(rhs).swap(*this);
        return *this;
    }

    intrusive_ptr & operator=(T * rhs) BOOST_SP_NOEXCEPT
    {
        this_type(rhs).swap(*this);
        return *this;
    }
    ...
    void reset( T * rhs ) BOOST_SP_NOEXCEPT
    {
        this_type( rhs ).swap( *this );
    }

    void reset( T * rhs, bool add_ref ) BOOST_SP_NOEXCEPT
    {
